                ...
                <div class="detatwo-wrap">
                    ...
                    <div class="detatwo-price">
                        ...
                        <div class="detatwo-day">
                            ...
                            <span class="time-wrap" style="display: none;">限時搶購
                                <span class="timer">
                                    <span id="hour"></span>
                                    :
                                    <span id="min"></span>
                        ...
                        <div class="detatwo-number" style="display: none;">
                    ...
                    <div class="details-knowledge">
                        ...
                        <div class="text-list">
                            <ul>
                                ...
                                <li>
                                    <h3>特别提醒</h3>
                                    <p class="red">香港順豐速運以下地區不配送，請知悉哦！</p>
                                    <p class="red">長洲、梅窩、馬灣、愉景灣、平州、大嶼山北面（貝澳）香港所有的政府部門 香港所有醫院、香港所有領事館、香港所有酒店</p>
                                    <br>
                                    <br>
                                </li>
                            </ul>
                    ...
                    <div id="inputBox" class="main-bg">
                        <div class="main">
                            ...
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    <input type="text" name="mobile" placeholder="+852 示例：92090657">
                                </div>
                            </div>
                            <div class="main-box">
                            ...
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    ...
                                    <input type="hidden" id="area_val" name="area" value="香港">
                                    <input type="hidden" name="province" id="province" value="香港" >
                                    <input type="hidden" name="city" id="city_select" value="香港" >
                                </div>
                            </div>
                            <div class="main-box">
                                <div class="label">* 住址</div>
                                <div class="operation-box">
                                    <input type="text" name="address" placeholder="XX路XX號（Exact address）">
                                </div>
                            </div>
                            <div class="main-box">
