                    ...
                    <div id="inputBox" class="main-bg">
                        <div class="main">
                            ...
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    <input type="text" name="mobile" placeholder="（+65 90606183）">
                                </div>
                            </div>
                            <div class="main-box">
                            ...
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    ...
                                    <input type="hidden" name="province" id="province" value="Singapore">
                                </div>
                            </div>
                            <div class="main-box">
                                <div class="label">Area</div>
                                <div class="operation-box">
                                    <input type="text" id="area_val" name="area" >
                                </div>
                            </div>
                            <div class="main-box">
                            ...
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    <textarea name="comment" placeholder="Note"></textarea>
                                </div>
                            </div>
                            <div class="main-box">
