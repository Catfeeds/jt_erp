    ...
    <div class="page-group detatwo">
        ...
        <div class="page" id="cart-attr">
            <header class="bar bar-nav" style="background-color: #000;">
                ...
                <h1 class="title">Confirm the order information</h1>
            </header>
            <div class="content">
                        ...
                        <div class="main">
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    <input type="text" name="inputName" placeholder="Please fill in your full name">
                                </div>
                            </div>
                            <div class="main-box">
                            ...
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    <input type="text" name="email" placeholder="Please fill in your email address">
                                </div>
                            </div>
                            <div class="main">
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    ...
                                    if($provinces):
                                        ...
                                        echo \yii\helpers\Html::dropDownList('province', '', ['' => 'Province'] + $options, ['onchange'=>'getCity("'.$website->sale_city.'", this)', 'id' => 'province']);
                                    else:
                                    ?>
...
<!--                            </div>-->
                                <div class="main-box">
                                    ...
                                    <div class="operation-box">
                                        <input type="text" name="street" placeholder="Fill in Street/Road/Avenue/Block">
                                    </div>
                                </div>
                                <div class="main-box">
                                    <div class="label">Building</div>
                                    <div class="operation-box">
                                        <input type="text" name="building" placeholder="Fill in the Building #">
                                    </div>
                                </div>
                                <div class="main-box">
                                    <div class="label">* Room</div>
                                    <div class="operation-box">
                                        <input type="text" name="room" placeholder="Fill in the Room XX">
                                    </div>
                                </div>
                            <div class="main-box">
                            ...
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    <textarea name="comment" placeholder="If you can't place an order, pleast contact us"></textarea>
                                </div>
                            </div>
                            <div class="main-box">
                                ...
                                <div class="operation-box activity">
                                    ...
                                    <p>Important attention: check before you pay for the goods</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-block">
                ...
                <div class="card" style="min-height: 2rem;padding: 10px;">
                    <div class="card-content" style="padding:0 25px;">
                        ...
                        <p style="color:#339966;font-size: 1rem;text-align:center;">Buying success</p>
                        <p style="color:#ff7300;font-size: 0.8rem;text-align:center">
                            Order Number: <span id="order_id"></span><br>
                            You snap up successfully. <br>
                            Please make sure your phone is on, we will ship the item to you as soon as possible
                        </p>
                        <p style="color: red;font-size: 16px;">
                            Note: On our website,the payment method is only COD(Cash on Delivery).We don't ask our customers to transfer money to us or pay with other payment methods for any reason
                        </p>
                        Contact us:<br>
