            ...
            <div class="content">
                <div class="details-wrap">
                    <div class="details-header">
                        <a href="/" class="goback">
                            <img src="/themes/<?=$website->theme;?>/images/detail-back.png">
                        </a>
                    </div>
                    <!-- banner S -->
                    ...
                    <!-- banner E -->
                    <div class="details-title">【แท็บเล็ตพีซีเปลี่ยนเป็นโน๊ตบุ๊คทันที】แป้นพิมพ์บลูทูธแบบพลิก</div>
                        ...
                        <div class="info">
                            <div class="line2">
                                <div class="retail-price">
                                    ...
                                    <span class="fr">
                                        <i class="this_i"></i>
                                        จำนวนที่เหลือ100</span> -->
                                </div>
                                <div class="market_price_onr">
                                    <!-- <span>ราคาเดิม</span>
                                    <del>฿4999</del> -->
                                </div>
                                <div class="stat">ฟรีค่าส่งเวลาที่คาดว่าจะส่งถึง<span id="timer">8/4-8/9</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="detail-spec-select">
                        <div class="m-listItem">
                            <div class="f-vc">
                                <div class="inner">
                                    <span class="it">กรุณาเลือกพารามิเตอร์</span>
                                </div>
                            </div>
                            <i class="icon"></i>
                        </div>
                    </div>
                    <div class="detail-dt-section">
                        <div class="btn">
                            <a href="javascript:void(0);" class="w-button btn-addToCart">รีบซื้อเลย</a>
                        </div>
                        <div class="btn">
                            <a href="javascript:void(0);" class="inquiry">ตรวจสอบสถานะการสั่งซื้อ</a>
                        </div>  
                    </div>
                    <div id="info" class="detail-product-info"></div>
            ...
            <div class="content-block">
                ...
                <div class="card" style="min-height: 2rem;padding: 10px;">
                    <div class="card-content" style="padding:0 25px;">
                        <p style="text-align:center"><img width="100px" src="/themes/<?=$website->theme;?>/images/th_success-icon.png"></p>
