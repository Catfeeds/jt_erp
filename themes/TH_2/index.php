    ...
    <div class="page-group detatwo">
        <div id="home" class="page page-current">
            <div class="content">
                <div class="detatwo-wrap">
                    ...
                    <div class="detatwo-bars">
                        ...
                        <li>ข้อมูลจำเพาะของสินค้า</li>
                        <li>คำสั่งซื้อล่าสุด</li>
                    </div>
                    <!-- product-info S -->
                    ...
                    <div class="detatwo-page-order detatwo-context">
                        <div class="order-title">
                            <h1>คำสั่งซื้อล่าสุด</h1>
                        </div>
                    </div>

                    <div class="detatwo-recommend-products">
                        <h3>คุณอาจจะสนใจสินค้า…</h3>
                        <dl class="clearfix">
                            <dt>
                                <a href="###"><img src="/themes/<?=$website->theme;?>/images/detatwo_pic1.jpg"></a>
                            </dt>
                            <dd>
                                <h5>2018 รองเท้าลำลองสำหรับคุณแม่ ส้นเตารีด สไตล์ใหม่</h5>
                                <div class="price">฿1480</div>
                                <a class="buy-now" href="###">ซื้อเลย</a>
                            </dd>
                        </dl>
                    </div>
                    -->
            ...
            <nav class="bar bar-tab details-nav">
                ...
                <a class="tab-item" href="#cart-attr"><span></span><span>ช็อปปิ้งตอนนี้</span></a>
            </nav>
        </div>
                    ...
                    <div id="inputBox" class="main-bg">
                        <div class="main">
                            ...
                            <div class="main-box">
                                ...
                                <div class="operation-box">
                                    <input type="text" name="mobile" placeholder="โปรดใส่หมายเลขโทรศัพท์ของคุณ（09 XXXX XXXX）">
                                </div>
                            </div>
                            <div class="main-box">
                ...
                <div class="card" style="min-height: 2rem;padding: 10px;">
                    <div class="card-content" style="padding:0 25px;">
                        ...
                        <p style="color:#ff7300;font-size: 0.8rem;text-align:center">
                            *ไอดีการสั่งซื้อของคุณ: <br><span id="order_id"></span><br>
                            *เก็บเงินปลายทาง ยอดรวม:<span id="order_price"></span> บาท
                        <p>
