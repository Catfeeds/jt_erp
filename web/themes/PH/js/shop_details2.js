...
$(function (){
    ...
    $detailsForm.submit(function (){
        for (var i = 0; i < $inputs.length; i++){
            ...
            if (_input.val() == '' && _input.attr('name')!='email' && _input.attr('name')!='building' && _input.attr('name')!='room'){
                _input.focus();
                return false;
            }
        }
        ...
        var address = $('input[name=street]').val()+" "+$('input[name=building]').val()+" "+$('input[name=room]').val();
