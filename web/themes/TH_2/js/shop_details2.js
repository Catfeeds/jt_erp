    ...
    $.ajax({
        ...
        success: function (res){
            ...
            priceContxtHtml = '<div class="dc-price">\
                                    ...
                                    <span class="o-price">' + currency + _product.price + '</span>\
                                </div>\
                                <span class="flag">จัดส่งฟรี</span>\
                                <span class="flag">เก็บเงินปลายทาง</span>\
                                <span class="flag">รับประกันเปลี่ยน/คืนสินค้าภายใน 7 วัน</span>';
            $('.detatwo-price .price-context').html(priceContxtHtml);
            // datatwo-number
            detatwoNumberHtml = '<span>' + res.orderCount + ' คำสั่งซื้อ</span>\
                                <span>\
                                    <span></span>\
                                </span>\
                                <span>89%</span>';
